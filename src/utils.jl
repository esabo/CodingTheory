...
cochain(C::ChainComplex) = ChainComplex([transpose(∂) for ∂ in reverse(C.boundaries)])

function ⊗(chain_A::ChainComplex{T}, chain_B::ChainComplex{T}) where T
...
# TODO: move to a classical code file
