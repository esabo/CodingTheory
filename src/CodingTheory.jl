...
import Base:
    circshift, iseven, show, length, in, zeros, ⊆, /, *, ==, ∩, +, -, copy, isequal, ∘, ∈
...
const CTGroupAlgebra =
    GroupAlgebraElem{fpFieldElem,GroupAlgebra{fpFieldElem,FinGenAbGroup,FinGenAbGroupElem}}
const CTChainComplex = Union{ComplexOfMorphisms{AbstractAlgebra.FPModule{fpFieldElem}}} # residue and group algebras later
const CTPolyMatrix = Union{
    AbstractAlgebra.Generic.MatSpaceElem{fpPolyRingElem},
    AbstractAlgebra.Generic.MatSpaceElem{FqPolyRingElem},
}
const CTLRPolyElem = AbstractAlgebra.Generic.LaurentMPolyWrap{
    fpFieldElem,
    fpMPolyRingElem,
...
export AbstractCode,
    AbstractNonadditiveCode,
    AbstractNonlinearCode,
    AbstractAdditiveCode,
    AbstractLinearCode,
    AbstractLDPCCode,
...
export AbstractLDPCCode,
    AbstractNoiseChannel,
    AbstractClassicalNoiseChannel,
    AbstractBinaryErasureChannel,
    AbstractBinarySymmetricChannel,
    AbstractBAWGNChannel,
    LDPCEnsemble
# this needs an abstract type

include("Quantum/types.jl")
export AbstractSubsystemCode,
    AbstractSubsystemCodeCSS,
    AbstractStabilizerCode,
    AbstractStabilizerCodeCSS,
    AbstractGraphStateSubsystem,
    AbstractGraphStateSubsystemCSS,
    AbstractGraphStateStabilizer,
    AbstractGraphStateStabilizerCSS,
    AbstractHypergraphProductCode,
    AbstractEASubsystemCode,
    AbstractEASubsystemCodeCSS,
    AbstractEAStabilizerCode,
    AbstractEAStabilizerCodeCSS,
...
export kronecker_product,
    ...
    print_string_array,
    print_char_array,
    print_symplectic_array,
    pseudoinverse,
    quadratic_to_symplectic,
    symplectic_to_quadratic,
    _remove_empty,
    quadratic_residues,
    digits_to_int,
    is_basis,
    primitive_basis, #polynomial_basis, monomial_basis,
    normal_basis,
    dual_basis,
    complementary_basis,
    verify_dual_basis,
...
export LDPCCode,
    ...
    average_simple_cycle_length,
    median_simple_cycle_length,
    ...
    average_short_cycle_length,
    median_short_cycle_length,
...
export remove_cycles,
    simple_cycle_length_distribution_plot,
    simple_cycle_distribution_by_variable_node_plot,
    short_cycle_length_distribution_plot,
...
export Gallager_A,
    ...
    sum_product_syndrome,
    min_sum,
    min_sum_syndrome,
    min_sum_with_correction,
    min_sum_with_correction_syndrome,
    layered_schedule,
...
export BinaryErasureChannel,
    BEC, BinarySymmetricChannel, BSC, BAWGNChannel, BAWGNC, capacity
...
export GeneralizedReedSolomonCode,
    scalars,
    dual_scalars,
    evaluation_points,
    AlternateCode,
...
export TwistedReedSolomonCode,
    twist_vector, hook_vector, coefficient_vector, number_of_twists
...
export concatenate,
    inner_code, outer_code, expansion_basis, expansion_dual_basis, concatenation_type
...
export SubsystemCode,
    ...
    gauge_operators,
    gauges_matrix,
    gauge_operators_matrix,
    dressed,
    dressed_operators,
    dressed_logicals,
    gauge_group,
    gauge_group_matrix,
    gauge_generators_matrix,
...
export StabilizerCodeCSS,
    ...
    set_X_minimum_distance!,
    set_Z_minimum_distance!
...
export FiveQubitCode,
    ...
    ToricCode4D,
    Q832,
    SmallestInterestingColorCode,
    GrossCode #, PlanarSurfaceCode3D, ToricCode3D
...
export Trellis,
    ...
    isequal,
    loadbalancedecode,
    trellisorientedformlinear,
    trellisprofiles,
    syndrometrellis,
    trellisorientedformadditive,
    optimalsectionalizationQ,
    weightQ!,
    shiftandweightQ!,
    shiftanddecodeQ!,
    shift!,
...
export polynomial,
    ...
    CWE_to_HWE,
    weight_enumerator,
    MacWilliams_identity,
    weight_distribution,
    weight_plot,
    support,
    minimum_distance_Gray,
    minimum_distance,
    Sterns_attack,
    minimum_words,
    words_of_weight
...
export minimum_distance_upper_bound!,
    random_information_set_minimum_distance_bound!, QDistRnd!
...
export HypergraphProductCode,
    GeneralizedShorCode,
    BaconCasaccinoConstruction,
    HyperBicycleCodeCSS,
    HyperBicycleCode,
    GeneralizedBicycleCode,
    generalized_hypergraph_product_matrices,
    GHGP_matrices,
    lifted_product_matrices,
    GeneralizedHypergraphProductCode,
    LiftedProductCode,
    bias_tailored_lifted_product_matrices,
...
export GeneralizedToricCode,
    FiniteGeneralizedToricCode,
    maximum_dimension,
