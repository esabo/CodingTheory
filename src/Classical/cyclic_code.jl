...
"""
    CyclicCode(n::Int, g::fqPolyRepPolyRingElem)

Return the length `n` cyclic code generated by the polynomial `g`.
"""
function CyclicCode(n::Int, g::fqPolyRepPolyRingElem)
    ...
    dic = Dict{fqPolyRepFieldElem, Int}()
    for i in 0:ord_E - 1
        dic[β^i] = i
    end
...
function _generator_polynomial(R::fqPolyRepPolyRing, β::fqPolyRepFieldElem, Z::Vector{Int})
...
_generator_polynomial(R::fqPolyRepPolyRing, β::fqPolyRepFieldElem, qcosets::Vector{Vector{Int}}) = _generator_polynomial(R, β, reduce(vcat, qcosets))

function _generator_matrix(F::fqPolyRepField, n::Int, k::Int, g::fqPolyRepPolyRingElem)
...
function _idempotent(g::fqPolyRepPolyRingElem, h::fqPolyRepPolyRingElem, n::Int)
