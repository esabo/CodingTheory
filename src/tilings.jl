...
A GAP reflection group together with its generators and defining `CoxeterMatrix`.
"""
...
Return `true` if `subgroup` lies in the orientation-preserving subgroup of `G`
generated by products of pairs of reflections; otherwise, return `false`.
"""
